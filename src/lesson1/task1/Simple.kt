 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = (PI * deg) / 180 + (PI * min) / 10800 + (PI * sec) / 648000
/**
 * Тривиальная (1 балл)
 *
...
fun trackLength(x1: Double, y1: Double, x2: Double, y2: Double):
        Double = sqrt(abs(x2 - x1).pow(2) + abs(y2 - y1).pow(2))
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = ((100 + percent) / 100.0).pow(3) * initial
